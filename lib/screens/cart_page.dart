...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      stream: FirebaseFirestore.instance.collection('foodcart').doc(user!.uid).snapshots(),
      builder: (context, snapshot) {
        var firestoreData = snapshot.data!.data();
        final Map<String, dynamic> doc = firestoreData as Map<String, dynamic>;
        List fooditems = doc['cart'];
        print(fooditems);
        return Padding(
